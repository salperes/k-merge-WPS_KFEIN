...
class SparkFunIMU
{
  ...
  public:
    ...
    virtual status_t begin(int GAIN) = 0; // Must be defined in derived classes
    ...
    virtual int16_t readMagX()   { return NAN; }
    virtual int16_t readMagY()   { return NAN; }
    virtual int16_t readMagZ()   { return NAN; }
	virtual uint16_t readTempValue()	{ return NAN; }
